 ...
 * @since 0.1
 */
add_action( 'add_meta_boxes', 'dmp_projects_metabox_description' );
 ...
 * @since 0.1
 */
function dmp_projects_metabox_description() {
    $id             = DMP_PROJECTS_FIELD_DESCRIPTION . '-box';
    $title          = __( 'Description', DMP_LANGUAGE ); 
    $callback       = 'dmp_projects_metabox_description_callback'; 
 ...
 * @return string
 */
function dmp_projects_metabox_description_callback( $post ) {
    $id = DMP_PROJECTS_FIELD_DESCRIPTION;
    ?>
    ...
    <p><?php _e( 'Your project description', DMP_LANGUAGE ); ?></p>
    <?php
}